...
def train(size, data, model, verbose):
    result1 = mini_noise_signal_cv(size, data, "taxol", "DMSO", model, 10, verbose)
    ...
    plt.title("Accuracy prediction score with change of %taxol")
    ...
    plt.title("Z_score with change of %taxol")
...
#                                "AreaShape_Area_Nuclei"]]
    lgr = KNeighborsClassifier(30)#LogisticRegression(max_iter = 10000, solver = "saga", n_jobs = -1)
